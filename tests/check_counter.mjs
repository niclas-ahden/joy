...
expect('init', html(root), '<div><button id="increment">+</button>0<button id="decrement">-</button></div>');
...
click('+');
expect('after +', html(root), '<div><button id="increment">+</button>1<button id="decrement">-</button></div>');
